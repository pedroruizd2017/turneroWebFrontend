...
// 22.1.3.31 Array.prototype[@@unscopables]
            ...
            if (ArrayProto[UNSCOPABLES] == undefined)
                _dereq_(41)(ArrayProto, UNSCOPABLES, {});
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
            _dereq_(41)(IteratorPrototype, _dereq_(115)('iterator'), function () {
                return this;
            });
...
// Shouldn't skip holes
            ...
            var ctx = _dereq_(27)
                    ...
                    , toLength = _dereq_(108)
                    , getIterFn = _dereq_(116);
            $export($export.S + $export.F * !_dereq_(55)(function (iter) {
                Array.from(iter);
            }), 'Array', {
...
// 19.2.3.6 Function.prototype[@@hasInstance](V)
            if (!(HAS_INSTANCE in FunctionProto))
                _dereq_(68).f(FunctionProto, HAS_INSTANCE, {value: function (O) {
...
// 21.2.5.3 get RegExp.prototype.flags()
            if (_dereq_(29) && /./g.flags != 'g')
                _dereq_(68).f(RegExp.prototype, 'flags', {
                    configurable: true,
                    get: _dereq_(37)
                });
